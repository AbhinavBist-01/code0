  ...
  const historyItems = [
    {
      ...
      prompt: "Build a modern glassmorphic SaaS analytics dashboard with dark theme, revenue charts...",
      date: "2 mins ago",
    ...
    },
    {
      ...
      prompt: "Design a 3-tier dark theme pricing section with monthly/yearly toggle...",
      date: "Yesterday",
      ...
      <div className="relative w-80 md:w-96 h-full glass-panel border-r border-zinc-800/90 flex flex-col z-10 shadow-2xl animate-in slide-in-from-left duration-300">
        ...
        <div className="p-4 border-b border-zinc-800/80 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-white text-sm">Generation History</h3>
          </div>
