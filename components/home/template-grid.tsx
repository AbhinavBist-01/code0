...
export const TemplateGrid: React.FC<TemplateGridProps> = ({
  ...
  const templates = [
    {
      ...
      category: "Dashboard",
      description: "Complete dark dashboard with revenue metrics, line chart, user table, and glass filters.",
      prompt: "Build a dark theme SaaS Analytics Dashboard with glass cards, line chart, activity feed, and metric cards.",
    ...
    },
    {
      ...
      description: "Modern login & sign-up forms with social buttons, passkey option, and red/orange glowing borders.",
      prompt: "Create a glassmorphic login & sign-up card suite with social buttons and glowing borders.",
    ...
    },
    {
      ...
      category: "Marketing",
      description: "3-tier responsive pricing cards with highlight plan, monthly/yearly toggle, and badge headers.",
      prompt: "Build a 3-tier dark mode pricing section with monthly/annual billing toggle and gradient highlight border.",
    ...
    },
    {
      ...
      description: "Conversational AI chat interface with message bubbles, prompt history sidebar, and code syntax blocks.",
      prompt: "Design an AI Chat Assistant UI with sidebar, message thread, code block formatting, and prompt input.",
  ...
  return (
    <div className={cn("w-full max-w-6xl mx-auto space-y-6 z-10 relative", className)}>
        ...
        {templates.map((tpl, idx) => (
          ...
          >
            ...
            <div className="relative z-10 pt-4 flex items-center justify-between text-xs text-orange-400 font-medium opacity-80 group-hover:opacity-100">
              ...
              <span className="text-[10px] text-zinc-500 font-mono">React + Tailwind</span>
            </div>
          </div>
        ))}
      </div>
